      ...
      <div className='w-full h-screen flex flex-col mb-20'>
        ...
        <div className='flex w-full justify-center  '>
          <div className=' grid grid-cols-3  w-[95%] max-sm:grid-cols-1 max-md:grid-cols-2 gap-8   leading-6  '>
            {lstTop.map((item, i) => (
              <div key={i} className={`flex  ${item.className}  flex-col  gap-y-3  items-center p-6 rounded-lg`}>
                <Image
                  src={Contact2Icon}
                  width={80}
                  height={80}
                ...
                <p className=' font-workSansSemiBold  text-2xl text-green-800'>{item.description}</p>
                ...
                <div className=' w-[100%] bg-blue-500 py-3 mt-2 rounded-md flex justify-center items-center gap-x-2  '>
                  ...
                  <span className=' text-white  font-workSansSemiBold '> Gọi ngay</span>
                </div>
              </div>
            ))}
          </div>
