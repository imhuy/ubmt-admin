    ...
    return (
      <div className='flex flex-col  h-full w-[400px]   '>
        ...
        <div className='flex flex-col '>
          ...
          <div className='flex shadow-lg rounded-lg justify-around   py-10 my-8  items-center    h-40'>
            ...
            <div className='flex flex-col   items-start gap-y-1'>
              <span className='  font-bold text-xl'>Ông NGUYỄN ĐẮC TÌNH</span>
              <div className='flex items-center'>
                <div className=' mx-2 w-2 h-2 bg-black' />
                <span className=' font-light'>
                  Mã đại biểu: <span className='font-semibold'>001938</span>
                </span>
              </div>
              ...
              <div className='flex items-center'>
                <div className=' mx-2 w-2 h-2 bg-black' />
                <span className=' font-light'>
                  Đoàn đại biểu: <span className='font-semibold'>Hoài Đức</span>
                </span>
              </div>
              ...
              <div className='flex items-center'>
                <div className=' mx-2 w-2 h-2 bg-black' />
                <span className=' font-light'>
                  Chức vụ: <span className='font-semibold'>Uỷ viên</span>
                </span>
              </div>
            </div>
          </div>
        ...
        <div className=' w-[400px] h-[600px] flex items-center flex-col  relative' id='capture'>
          ...
          <img src='/Anh34.jpg' alt='Sample Image' className='w-[98px] h-[147px]  absolute top-[287px] left-[36px] ' />

          <div className='absolute w-[70px] h-[70]  top-[440px] left-[45px]'>
            <SVG
              text={"https://github.com/bunlong/next-qrcode"}
              options={{
                margin: 2,
          ...
          <div className='flex flex-col self-center justify-start items-center absolute top-[365px] left-[150px]  w-[210px] '>
            <span className=' text-[#3760AE] uppercase  font-black  text-[15px] '>{name}</span>
          ...
          <div className='flex flex-col self-center justify-start items-center absolute top-[455px] left-[150px]  w-[210px] '>
            <span className=' text-[#3760AE] uppercase  font-black  text-[15px] '>Mã đại biểu : 00156572</span>
          </div>
        </div>
